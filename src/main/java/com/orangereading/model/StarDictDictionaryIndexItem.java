 ...
 *
 */
public class StarDictDictionaryIndexItem implements Serializable {
	...
	public StarDictDictionaryIndexItem() {
	}

	public StarDictDictionaryIndexItem(String word, Long offset, Integer size) {
		this.word = word;
		this.offset = offset;
		this.size = size;
	}
